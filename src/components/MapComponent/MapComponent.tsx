...
const testJson2: FeatureCollection = {
  type: 'FeatureCollection',
  features: [
    {
      type: 'Feature',
    ...
    },
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [14.1215698, 46.0677293],
      },
      properties: {
        name: 'Cacato nel puzzo',
      },
    },
    {
      type: 'Feature',
      geometry: {
        type: 'LineString',
        coordinates: [
          [14.1215698, 46.0677293],
          [11.1215698, 46.0677293],
        ],
      },
      properties: {
        name: 'NOOOO',
...
export function MapComponent() {
  return (
    <Map height={300} defaultCenter={[50.879, 4.6997]} defaultZoom={11}>
      ...
      <Marker width={30} anchor={[46.0677293, 11.1215698]} />
    </Map>
  );
}
